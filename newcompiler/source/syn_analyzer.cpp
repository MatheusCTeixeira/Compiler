...
namespace comp{
    ...
    void syn_analyzer::print_log(){
        ...
        std::cout << std::setw(15) << "stack" << " | " << std::setw(15) << "vector" << std::endl;
        while (this->m_log.size()){
            std::cout << std::setw(15) << this->m_log.front().first  << " | " << std::setw(15) << this->m_log.front().second << std::endl;  
